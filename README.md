...
| **do** | Adaptive task workflow with a local durable runner: answer, diagnose, review, plan, prototype, implement, operate, deliver, or monitor. Validates scoped handoffs, snapshots, independent reviews and bounded recovery. Host-mediated execution; Jev deferred. `complete` remains unchanged. |
